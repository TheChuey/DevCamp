# https://www.google.com/search?q=python+tutorial&rlz=1C1CHBF_enUS846US846&oq=python+tutorial


url = "https://www.google.com/search?q=python+tutorial&rlz=1C1CHBF_enUS846US846&oq="
tags = ['python', 'development', 'tutorial']
formated_tags = '+'.join(tags)
query_uri = f'{url}{formated_tags}'
